...
/**
 * Class _AppGroupRole was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _AppGroupRole extends BaseDataObject {

    private static final long serialVersionUID = 1L; 

    public static final String ID_PK_COLUMN = "id";

    public static final Property<AppUserGroup> GROUP = Property.create("group", AppUserGroup.class);
    ...
    public void setGroup(AppUserGroup group) {
        setToOneTarget("group", group, true);
    }

    public AppUserGroup getGroup() {
        return (AppUserGroup)readProperty("group");
    }
